...
class MenuEntryImpl : public MenuItem {
 ...
 public:
  MenuEntryImpl(const std::string &name, const std::string &note = "",
                MenuEntry *owner = nullptr);
  MenuEntryImpl(const std::string &name, FuncPointer func,
                const std::string &note = "", MenuEntry *owner = nullptr);
