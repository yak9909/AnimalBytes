...
class Menu {
 ...
 public:
  Menu(const std::string &title, const std::string &footer = "",
       IconCallback iconCallback = nullptr);
  ...
  ** >= 0 : user choice (irrelevant on menu using folders, so prefer using an
  *overload returning the object)
  *******************************************/
