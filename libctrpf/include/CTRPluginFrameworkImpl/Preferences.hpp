...
#define SETTINGS_VERSION SETTINGS_VERSION11
 public:
  ...
  static bool IsEnabled(u64 setting) { return (Flags & setting) > 0ULL; }

  static void Set(u64 setting) { Flags |= setting; }

  static void Clear(u64 setting) { Flags &= ~setting; }

  static void Toggle(u64 setting) { Flags ^= setting; }
