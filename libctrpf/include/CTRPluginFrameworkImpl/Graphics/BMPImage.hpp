...
class BMPImage {
 ...
 public:
  ...
  enum ColorPlane { BluePlane = 0, GreenPlane = 1, RedPlane = 2 };
  ...
  bool Region(const u32 &x, const u32 &y, const u32 &width, const u32 &height,
              BMPImage &destImage);
  // Cut an area of the image to another from center
  bool RoiFromCenter(const u32 cx, const u32 cy, const u32 &width,
