...
class MessageBoxImpl {
 public:
  MessageBoxImpl(const std::string &title, const std::string &message,
                 DialogType dtype, ClearScreen clear);
  MessageBoxImpl(const std::string &message, DialogType dtype,
                 ClearScreen clear);
  ~MessageBoxImpl(){};
