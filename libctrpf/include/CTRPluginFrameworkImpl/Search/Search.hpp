...
#define DB(new, old, check) \
  (new != old && (new == (old + check) || new == (old - check)))
...
#define FP_DB(new, old, check) \
  (FP_NE(new, old) && (FP_EQ(new, (old + check)) || FP_EQ(new, (old - check))))
#define FP_DBL(new, old, check) \
  (FP_NE(new, old) && FP_LE(std::fabs((int)(new - old)), check))
#define FP_DBM(new, old, check) \
  (FP_NE(new, old) && FP_GE(std::fabs((int)(new - old)), check))
...
#define U8_First_Unknown \
  (u32)(SearchFlags::U8 | SearchFlags::First | SearchFlags::Unknown)
#define U16_First_Unknown \
  (u32)(SearchFlags::U8 | SearchFlags::First | SearchFlags::Unknown)
#define U32_First_Unknown \
  (u32)(SearchFlags::U8 | SearchFlags::First | SearchFlags::Unknown)
#define U64_First_Unknown \
  (u32)(SearchFlags::U8 | SearchFlags::First | SearchFlags::Unknown)
#define Float_First_Unknown \
  (u32)(SearchFlags::U8 | SearchFlags::First | SearchFlags::Unknown)
#define Double_First_Unknown \
  (u32)(SearchFlags::U8 | SearchFlags::First | SearchFlags::Unknown)
...
#define IsSubsidiarySearch(flags) \
  (!(flags & (u32)(SearchFlags::First | SearchFlags::Second)))
