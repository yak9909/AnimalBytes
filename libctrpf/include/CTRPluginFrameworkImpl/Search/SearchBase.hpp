...
class Search {
 ...
 public:
  ...
  // Read results
  virtual void ReadResults(u32 index, StringVector &addr, StringVector &newVal,
                           StringVector &oldVal) = 0;
  const Header &GetHeader(void) const;
  u32 GetTotalResults(const Header &header) const;
  void ExtractPreviousHits(void *data, u32 index, u32 structSize, u32 &nbItem,
                           bool forced = false);
