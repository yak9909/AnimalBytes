...
// Allows to use the flags from Render::FontDrawMode to draw text in different
// modes.
...
// Aligns the string to the center of the specified borders. (Default values =
// top window size)
std::string CenterAlign(const std::string &str, u16 leftBorder = 35,
                        u16 rightBorder = 370);

// Aligns the string to the right of the specified borders. (Default values =
// top window size)
std::string RightAlign(const std::string &str, u16 leftBorder = 35,
                       u16 rightBorder = 370);
...
template <typename T, typename std::enable_if<
                        ...
                        !std::is_same<T, Color>::value>::type * = nullptr>
