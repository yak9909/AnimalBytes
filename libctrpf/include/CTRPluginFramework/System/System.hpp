...
class System {
 public:
   ...
   * A version number can be passed and if it's the case the function will
   * return whether the version of the cfw is the same or higher (true) or
   * inferior (false) \param major An optional version \param minor An optional
   * version \param revision An optional version \return If the cfw is Luma3DS
   * or not
   */
