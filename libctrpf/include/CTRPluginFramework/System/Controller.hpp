...
class Controller {
 public:
   ...
   */
  static inline u32 GetKeysPressed(void) { return _keysDown; }
   ...
   */
  static inline u32 GetKeysReleased(void) { return _keysReleased; }
  ...
  /**
   * @brief Inject a touch in the specified coordinates. May not work depending
   * on the game timing.
   *
