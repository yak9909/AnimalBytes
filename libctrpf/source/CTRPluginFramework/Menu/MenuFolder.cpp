...
void MenuFolder::Hide(void) const { _item->Hide(); }

void MenuFolder::Show(void) const { _item->Show(); }

bool MenuFolder::IsVisible() const { return (_item->IsVisible()); }
...
std::string &MenuFolder::Name(void) const { return (_item->name); }

std::string &MenuFolder::Note(void) const { return (_item->note); }

u32 MenuFolder::ItemsCount(void) const { return (_item->ItemsCount()); }

void MenuFolder::Clear(void) const { _item->Clear(); }
