...
PluginHeader *FwkSettings::Header =
  reinterpret_cast<PluginHeader *>(0x07000000);
FwkSettings &FwkSettings::Get(void) { return Preferences::Settings; }
...
void FwkSettings::SetThemeDefault(void)
{
  ...
  // UI Colors
  settings.MenuSelectedItemColor = settings.BackgroundBorderColor =
    settings.WindowTitleColor = settings.MainTextColor = Color::White;
