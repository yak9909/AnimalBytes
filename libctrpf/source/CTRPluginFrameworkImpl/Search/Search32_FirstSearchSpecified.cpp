...
void Search32::FirstSearchSpecifiedU8(u32 endAddress, SearchFlags compare,
                                      Results32 *result)
{
  switch( compare ) {
...
void Search32::FirstSearchSpecifiedU16(u32 endAddress, SearchFlags compare,
                                       Results32 *result)
{
  switch( compare ) {
    case SearchFlags::Equal: {
...
void Search32::FirstSearchSpecifiedU32(u32 endAddress, SearchFlags compare,
                                       Results32 *result)
{
  switch( compare ) {
    case SearchFlags::Equal: {
...
void Search32::FirstSearchSpecifiedFloat(u32 endAddress, SearchFlags compare,
                                         Results32 *result)
{
  switch( compare ) {
    case SearchFlags::Equal: {
