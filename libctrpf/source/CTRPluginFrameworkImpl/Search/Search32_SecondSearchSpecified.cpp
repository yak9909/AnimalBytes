...
void Search32::SecondSearchSpecifiedU8(Storage<Results32> &data,
                                       SearchFlags compare,
    ...
    switch( compare ) {
      case SearchFlags::Equal: {
        for( Results32 &res : data ) {
          if( _resultsInPool > _maxResults ) break;
...
void Search32::SecondSearchSpecifiedU16(Storage<Results32> &data,
                                        SearchFlags compare,
                                        Results32WithOld *result)
{
...
void Search32::SecondSearchSpecifiedU32(Storage<Results32> &data,
                                        SearchFlags compare,
                                        Results32WithOld *result)
{
...
void Search32::SecondSearchSpecifiedFloat(Storage<Results32> &data,
                                          SearchFlags compare,
                                          Results32WithOld *result)
{
    ...
    switch( compare ) {
      ...
      case SearchFlags::DifferentBy: {
        for( Results32 &res : data ) {
          ...
          if( IsValid(oldValue) &&
              FP_DB(newValue, oldValue, _checkValue.Float) ) {
            result->address = res.address;
            result->newValue.Float = newValue;
            result++->oldValue.Float = oldValue;
            _resultsInPool++;
      ...
      case SearchFlags::DifferentByLess: {
        for( Results32 &res : data ) {
          ...
          if( IsValid(oldValue) &&
              FP_DBL(newValue, oldValue, _checkValue.Float) ) {
            result->address = res.address;
            result->newValue.Float = newValue;
            result++->oldValue.Float = oldValue;
            _resultsInPool++;
      ...
      case SearchFlags::DifferentByMore: {
        for( Results32 &res : data ) {
          ...
          if( IsValid(oldValue) &&
              FP_DBM(newValue, oldValue, _checkValue.Float) ) {
            result->address = res.address;
            result->newValue.Float = newValue;
            result++->oldValue.Float = oldValue;
            _resultsInPool++;
