...
void Search32::SecondSearchUnknownU8(Storage<u32> &data, SearchFlags compare,
                                     Results32WithOld *result)
{
  ...
  switch( compare ) {
    case SearchFlags::Equal: {
      for( u32 v : data ) {
        if( _resultsInPool > _maxResults - 4 ) break;
...
void Search32::SecondSearchUnknownU16(Storage<u32> &data, SearchFlags compare,
                                      Results32WithOld *result)
{
  u32 address = _startRegion + _currentAddress * 4;
  ...
  switch( compare ) {
    case SearchFlags::Equal: {
      for( u32 v : data ) {
        if( _resultsInPool > _maxResults - 2 ) break;
...
void Search32::SecondSearchUnknownU32(Storage<u32> &data, SearchFlags compare,
                                      Results32WithOld *result)
{
  u32 address = _startRegion + _currentAddress * 4;
...
void Search32::SecondSearchUnknownFloat(Storage<u32> &data, SearchFlags compare,
                                        Results32WithOld *result)
{
  u32 address = _startRegion + _currentAddress * 4;
