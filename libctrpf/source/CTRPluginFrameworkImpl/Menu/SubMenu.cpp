...
void SubMenu::Draw(void)
{
  ...
  // Draw background
  Renderer::DrawRect2(background, Preferences::Settings.BackgroundMainColor,
...
bool SubMenu::IsOpen(void) { return _isOpen; }
...
u32 SubMenu::OptionsCount(void) { return _options.size(); }
}  // namespace CTRPluginFramework
