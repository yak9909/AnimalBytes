...
bool drop_check(u8* wx_out, u8* wy_out, u8* u0_out, bool disallow_concrete,
                u8 u1);
bool place_item(u8 type, u32* item_to_replace, u32* item_to_place,
                u32* item_to_show, u8 wx, u8 wy, bool is_inside, u8 u0, u8 u1,
                u8 u2, u8 u3);
