...
void TextEditorImpl::_hook_init()
{
  ...
  std::pair<u32*, u32> const hookMap[]{
    ...
    // Enter
    {(u32*)_ZN18CTRPluginFramework12KeyboardImpl3RunEv + 117,
     0xEA00000B},  // don't exit
    {(u32*)_ZN18CTRPluginFramework12KeyboardImpl10_CheckKeysEv + 199,
     0xE28FF008},

    // Backspace
    {(u32*)_ZN18CTRPluginFramework12KeyboardImpl10_CheckKeysEv + 339,
     0xE3550001},

    // Draw editor
    {(u32*)_ZN18CTRPluginFramework12KeyboardImpl10_RenderTopEv, asmjmp},
    {(u32*)_ZN18CTRPluginFramework12KeyboardImpl10_RenderTopEv + 1,
     (u32)TextEditorImpl::_KbdImpl_RenderTop_hook},

    // bottom
    {(u32*)_ZN18CTRPluginFramework12KeyboardImpl13_RenderBottomEv + 134,
     asmjmp},
    {(u32*)_ZN18CTRPluginFramework12KeyboardImpl13_RenderBottomEv + 135,
     (u32)_hookHelperFn_KbdImpl_RenderBottom},
  };
