...
MenuFolder* make_folder()
{
  MenuFolder* folder = new MenuFolder(
    "SpeedHacks", "",
    {new MenuEntry("スピードハックメニュー " FONT_B " + " FONT_DD,
                   speedhackmenu),
     new MenuEntry("ゲームスピード上昇 " FONT_B " + " FONT_DU,
                   gamespeed_boost)});
...
MenuFolder* make_folder()
{
  auto folder = new MenuFolder(
    "Item Drops", "",
    {EnableEntry(
       new MenuEntry("アイテム変更 " FONT_R " + " FONT_DU, item_changer)),
