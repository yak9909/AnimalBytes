...
{
  return ACNL::Game::place_item(this->type, (u32*)0x955FF4, &this->item,
                                &this->item, wx, wy, 0, 0, 0, 0, 0);
}

void CodeContext::init()
{
  static_assert(sizeof(CodeContext) < 0x1000,
                "Size of CodeContext is too big to place to 0x838000, must "
                "less than 0x1000.");
